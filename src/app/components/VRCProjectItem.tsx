...
import { VRCProject } from "@/lib/VRCProject";
    ...
    return (
        <li className="w-full p-2 flex flex-row justify-between">
            <div className="inline-flex items-center shrink grow min-w-0">
                <AccountIcon width={40} height={40} className="shrink-0"/>
            ...
            <div className="ml-auto shrink-0 self-center">
                <button className=" border rounded-3xl py-1 px-8 text-center font-extrabold border-primary text-white bg-primary ">パッケージを管理</button>
